        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="IdUsuario">
                <Columns>
                    ...
                    <asp:BoundField DataField="IdUsuarioFK" HeaderText="IdUsuarioFK" SortExpression="IdUsuarioFK" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conexionBD %>" SelectCommand="SELECT [IdUsuario], [IdRol], [IdUsuarioFK], [IdEstadoUsuario], [IdTipoUsuario], [NombreUsuario], [APaterno], [AMaterno], [CodigoRecuperacion], [EmailUsuario], [PassWordUsuario] FROM [T_Usuario]"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
